...
cmake_dependent_option(adrtxt_ASAN "Whether to link with AddressSanitizer" ON
  "PROJECT_IS_TOP_LEVEL;NOT adrtxt_MSAN;NOT adrtxt_TSAN;adrtxt_DEV" OFF)
set(sanitizer_list "")
if(adrtxt_ASAN)
...
cmake_dependent_option(adrtxt_MSAN "Whether to link with MemorySanitizer" OFF
  "PROJECT_IS_TOP_LEVEL;NOT adrtxt_ASAN;NOT adrtxt_TSAN;adrtxt_DEV" OFF)
cmake_dependent_option(adrtxt_TSAN "Whether to link with ThreadSanitizer" OFF
  "PROJECT_IS_TOP_LEVEL;NOT adrtxt_ASAN;NOT adrtxt_MSAN;adrtxt_DEV" OFF)
cmake_dependent_option(adrtxt_UBSAN "Whether to link with"
  "UndefinedBehaviorSanitizer" ON "PROJECT_IS_TOP_LEVEL;adrtxt_DEV" OFF)
if(adrtxt_MSAN)
  if(CMAKE_CXX_COMPILER_ID MATCHES "Clang"
      OR
      CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
